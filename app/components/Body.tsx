  ...
  return (
    ...
    <div className="bg-purple-900">
      ...
      <div className="flex items-center justify-center h-screen">
        {/* card content */}
        <div className="bg-white min-w-max p-5 rounded-xl h-2/3">
          {/* input elements */}
          <div className="flex">
            <input
              type="text"
              ...
              onChange={itemEvent}
              className="border-s-gray-500"
            />
            <button
              type="button"
              className="bg-purple-900 text-white font-semibold px-5 py-2 rounded-[3px]"
              onClick={listOfItem}
            >
              add
            </button>
